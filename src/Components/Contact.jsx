  ...
  return (
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/akkkgwga"
          method="POST"
        ...
        >
          ...
          <button
            type="submit"
            className="btn btn-primary [&]:max-w-full w-full justify-center hover:bg-zinc-50
               hover:text-zinc-950 active:bg-zinc-50/80 transition-all"
          >
            Send
          </button>
        </form>
